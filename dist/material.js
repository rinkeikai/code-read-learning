import { extractFilesFromDiff, extractFunctionsFromDiff, } from "./diffParser.js";
import { resolveDiff } from "./git.js";
import { getExcludePathsForRoot, getGitRootForModule, hasMultipleModules, listModules, resolveModule, } from "./modules.js";
import { inferRecommendedOrder } from "./order.js";
import { LEARNING_PROMPT } from "./prompt.js";
function buildModuleSelectionRequired(modules) {
...
export async function buildLearningMaterial(projectRoot, options = {}) {
    ...
    const excludePaths = targetModule.type === "root" ? getExcludePathsForRoot(modules) : [];
